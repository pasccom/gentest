...
/*** INTEGERS GENERATORS *****************************************************/
    ...
    parentObject.types.int.nonZero = parentObject.types.suchThat((x) => (x !== 0), parentObject.types.int);
...
/*** INTEGERS GENERATORS *****************************************************/
    parentObject.types.real = parentObject.types.float(null, null);
    parentObject.types.real.nonZero = parentObject.types.suchThat((x) => (x !== 0), parentObject.types.float);
    parentObject.types.real.nonNegative = parentObject.types.float(0, null);
    parentObject.types.real.negative = parentObject.types.float(null, 0);
    parentObject.types.real.positive = parentObject.types.fmap((x) => -x, parentObject.types.real.negative);
    parentObject.types.real.nonPositive = parentObject.types.fmap((x) => -x, parentObject.types.real.nonNegative);
