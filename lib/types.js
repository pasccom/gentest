    ...
    parentObject.types.arrayOf = function(elemGen) {
        return function(rng, size) {
            ...
            return new parentObject.RoseTree(elemTrees.map(function(tree) { return tree.root; }), function() {
                return parentObject.shrink.array(elemTrees, 0);
            });
        };
    };
    parentObject.types.nonEmptyArrayOf = function(elemGen) {
        return function(rng, size) {
            var len = parentObject.types.int.positive(rng, size).root;
            ...
            return new parentObject.RoseTree(elemTrees.map(function(tree) { return tree.root; }), function() {
                return parentObject.shrink.array(elemTrees, 1);
            });
        };
    };
